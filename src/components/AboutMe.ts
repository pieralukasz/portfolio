...
class AboutMe extends HTMLElement {
    ...
    template(): string {
        return `
            ...
            <div class="aboutme">
                ...
                <div class="information-hello" style="top: 200%">Łukasz Piera<br>Aspiring Web Developer</div>
                ...
                <div class="cv-download" style="top: 650%">My CV
                    <div class="polish rainbow">POLISH</div>
                    <div class="english rainbow">ENGLISH</div>
                </div>
    ...
    checkWidthAll(): void {
        ...
        this.checkWidthElement(this.getPage('information-hello'), wholePercentage)
        this.checkWidthElement(this.getPage('information-more'), wholePercentage)
